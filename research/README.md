...
This folder stores user research artifacts — interviews, user case documents, session analyses, and synthesis outputs.

## Convention

One file per research artifact. Use the naming pattern `YYYY-MM-topic.ext`. Add a row to the index below when filing a new artifact.
...
- Research files are read-only reference material. Do not edit filed artifacts.
- Findings that drive product decisions should be referenced in `PLAN.md` or open issues.
